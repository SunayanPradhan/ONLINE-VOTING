...
class CountListAdapter(var list: ArrayList<VoteInformation>, var context: Context): RecyclerView.Adapter<CountListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent=Intent(context,VoteCountActivity::class.java)
